...
WeaponParticle1 = AnimatedEntity.extend({
  m_AlphaSpeed: 0,
  m_ScaleSpeed: 0,
  m_RotationSpeed: 0,
  m_VectorX: 0,
  ...
  onCreate: function() {
    ...
    this.setCurrentFrameIndex(id * 3 + 2);
  ...
  deepCopy: function() {
    return WeaponParticle1.create();
  }
});

WeaponParticle1.create = function() {
  var entity = new WeaponParticle1();
