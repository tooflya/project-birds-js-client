...
LivesRequest = ExtendedPopup.extend({
  ctor: function(parent) {
    ...
    this.m_List = LivesRequestList.create(this.m_Background);
    ...
    this.m_CloseButton.setTouchHandler('onCloseEvent', LivesRequest);
  },
  onShow: function() {
    this._super();
  },
...
LivesRequest.instance = false;
LivesRequest.sharedScreen = function(parent) {
  if(LivesRequest.instance) {
    LivesRequest.instance.m_Parent = parent;
  } else {
    LivesRequest.instance = new LivesRequest(parent);
  }

  return LivesRequest.instance;
};
