...
Achievements = ExtendedPopup.extend({
  ctor: function(parent) {
    ...
    this.m_List = AchievementsList.create(this.m_Background);
    ...
    this.m_CloseButton.setTouchHandler('onCloseEvent', Achievements);
  },
  onShow: function() {
    this._super();
  },
...
Achievements.sharedScreen = function(parent) {
  if(Achievements.instance) {
    Achievements.instance.m_Parent = parent;
  } else {
    Achievements.instance = new Achievements(parent);
  }
